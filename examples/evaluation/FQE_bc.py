...
from myosrl.algorithms import BC
...
class EvalConfig:
    ...
    path: str = "/home/wyf/projects/OSRL_for_Vent/examples/vent/logs/BC/bc/bc"
...
bc_model.to(eval_config.device)
...
evaluate_strategy(bc_model, q_network, dataset)
